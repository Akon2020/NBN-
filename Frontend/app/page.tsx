...
const COMPANY = {
  ...
  whatsapp: "243977103143",
  address: "22 Av. Résidence / En Face de Gardaworld, Bukavu, Sud-Kivu, RDC",
...
const TRUST_POINTS = [
  {
    ...
    title: "Ancrage local",
    description:
      "Une équipe présente sur le terrain à Bukavu, qui connaît chaque quartier du Sud-Kivu.",
  },
  {
    icon: MessageCircle,
    title: "Réponse rapide sur WhatsApp",
    description:
      "Contact direct avec un conseiller, photos et détails du bien envoyés immédiatement.",
  },
  {
    icon: ShieldCheck,
    title: "Biens vérifiés",
    description:
      "Chaque propriété présentée est visitée et évaluée par notre équipe avant d'être proposée.",
  },
  {
    icon: Handshake,
    title: "Accompagnement de bout en bout",
    description:
      "De la première visite à la remise des clés, un seul interlocuteur suit votre dossier.",
  },
];
...
const SHOWCASE_IMAGES = [
  ...
  {
    src: "/durable-house-sale-bukavu.jpg",
    alt: "Maison en construction durable à vendre",
  },
  {
    src: "/flat-land-plot-bukavu.jpg",
    alt: "Terrain plat disponible à Bukavu",
  },
];
...
export default function LandingPage() {
  return (
    <div
      className={`${manrope.variable} ${inter.variable} min-h-screen font-[family-name:var(--font-body)]`}
    >
      {/* Header */}
      <header className="sticky top-0 z-50 w-full border-b border-border bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="container mx-auto flex h-16 items-center justify-between px-4 md:px-6">
          ...
          <nav className="hidden items-center gap-6 md:flex">
            <Link
              href="#services"
              className="text-sm font-medium text-foreground hover:text-accent-600 transition-colors"
            >
              Services
            </Link>
            <Link
            ...
            <div className="flex flex-col justify-center space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-lg text-white/80 text-pretty leading-relaxed md:text-xl">
                  Nyumbani Express accompagne particuliers et familles à Bukavu
                  pour louer, vendre, acheter ou s&apos;installer, avec une
                  équipe locale qui connaît chaque quartier.
                </p>
              </div>
              <div className="flex flex-col gap-3 sm:flex-row">
                <Button
                  asChild
                  size="lg"
                  className="h-12 bg-accent-600 px-8 text-white hover:bg-accent-600/90"
                >
                  <Link href="/demande-location">
                ...
                >
                  <a
                    href={whatsappHref(
                      "Bonjour, je recherche un bien avec Nyumbani Express.",
                    )}
                  >
              ...
              <div className="flex flex-wrap items-center gap-6 pt-4">
                {["Location", "Vente", "Conseil", "Déménagement"].map(
                  (label) => (
                    <div
                      key={label}
            ...
            <div className="relative lg:h-[560px]">
              <div className="grid h-full grid-cols-2 gap-4">
                <div className="relative overflow-hidden rounded-2xl shadow-2xl">
                  <Image
                    src="/modern-apartment-bukavu.jpg"
                    alt="Appartement moderne à Bukavu"
                    fill
                ...
                <div className="flex flex-col gap-4">
                  <div className="relative flex-1 overflow-hidden rounded-2xl shadow-2xl">
                    <Image
                      src="/house-bukavu-ibanda.jpg"
                      alt="Maison à Ibanda, Bukavu"
                      fill
                      className="object-cover"
                    />
                  </div>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="mx-auto max-w-3xl text-center space-y-4 mb-16">
            ...
            <p className="text-lg text-muted-foreground text-pretty leading-relaxed">
              Du premier contact à l&apos;installation, Nyumbani Express couvre
              l&apos;ensemble de vos besoins immobiliers à Bukavu
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="mt-8 text-center">
            <Button
              asChild
              variant="outline"
              className="border-primary-900 text-primary-900 hover:bg-primary-900 hover:text-white dark:border-white dark:text-white"
            >
              <a
                href={whatsappHref(
                  "Bonjour, pouvez-vous m'envoyer la liste actuelle des biens disponibles ?",
                )}
              >
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            <div className="space-y-6">
              <span className="text-sm font-semibold uppercase tracking-wide text-accent-600">
                Pourquoi Nyumbani Express
              </span>
              <h2 className="font-[family-name:var(--font-display)] text-3xl font-bold tracking-tight text-balance sm:text-4xl md:text-5xl">
                Une agence de confiance, ancrée à Bukavu
              </h2>
              <p className="text-lg text-muted-foreground text-pretty leading-relaxed">
                Nous connaissons le terrain : les quartiers, les prix réels du
                marché, les démarches locales. Notre équipe accompagne chaque
                client personnellement, du premier échange sur WhatsApp
                jusqu&apos;à l&apos;installation dans le nouveau logement.
              </p>
              <div className="flex items-center gap-3 rounded-xl border border-border bg-card p-4">
                <Clock className="h-5 w-5 shrink-0 text-secondary-600" />
                <p className="text-sm text-muted-foreground">
                  Une équipe disponible pour répondre rapidement à vos demandes,
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="mx-auto max-w-3xl text-center space-y-8">
            ...
            <p className="text-lg text-white/80 text-pretty leading-relaxed">
              Contactez notre équipe dès maintenant - un conseiller vous répond
              directement sur WhatsApp ou par téléphone
            </p>
            <div className="flex flex-col gap-3 sm:flex-row sm:justify-center">
              ...
              >
                <a
                  href={whatsappHref(
                    "Bonjour, je souhaite discuter d'un projet immobilier avec Nyumbani Express.",
                  )}
                >
                  <MessageCircle className="mr-2 h-5 w-5" />
                  Discuter sur WhatsApp
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
            <div className="space-y-4">
              ...
              />
              <p className="text-sm text-muted-foreground leading-relaxed">
                Agence immobilière - location, vente, conseil et accompagnement
                à Bukavu, Sud-Kivu, RDC.
              </p>
            </div>
            <div className="space-y-4">
