...
<div style="font-family: Arial, sans-serif; background-color: #f9f9f9; padding: 20px;">
  <div style=" max-width: 600px; margin: auto; background-color: #ffffff; padding: 20px; border-radius: 10px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);">
    ...
    <p style="color: #555555">L'équipe de <a href="${url}" style="color: #a42223; text-decoration: none">Logistra</a></p>
    ...
    <p style="color: #999999; text-align: center;">&copy; ${currentYear} Logistra – Tous droits réservés</p>
    </div>
</div>
`;
};
  ...
  return `<div style="font-family: Arial, sans-serif; background-color: #f9f9f9; padding: 20px;">
    <div style="max-width: 600px; margin: auto; background-color: #ffffff; padding: 20px; border-radius: 10px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);">
      <div style="text-align: center; padding-bottom: 20px;">
        <img src="https://logistra-app.vercel.app/images/logo-ucb.png" alt="Logo" style="max-width: 100%; width: auto; height: 5rem;">
      </div>
      <h2 style="color: #333333">Bienvenue ${nom} 👋!</h2>
        ...
        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="max-width: 600px; background-color: #ffffff; padding: 24px; border-radius: 8px; box-shadow: 0 4px 6px rgba(0,0,0,0.05); font-family: Arial, sans-serif;">
          ...
          <tr>
            <td align="center" style="color: #999999; font-size: 12px; padding-top: 20px;">
              &copy; ${currentYear} Logistra – Tous droits réservés
            </td>
          </tr>
        </table>
      </td>
...
export const unsubscribeNewsletterTemplate = (email) => {
  return `Un template email pour le désabonnement ${email}`;
};
